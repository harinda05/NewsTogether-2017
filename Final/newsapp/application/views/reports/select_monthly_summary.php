...
<body>
	<?php require $_SERVER['DOCUMENT_ROOT'] . '/newsapp/application/views/mod/header-sidebar.php'?>
		<div class="panel panel-default" style="margin-top: 20px">
            ...
            <p class="panel-title"><h3>Monthly News Summary</h3></p>
         	</div>
			<div class="panel-body">

			<form method='GET' action='<?php echo site_url("/reports/get_monthly_summary") ?>'>
			 ...
			 <div class="form-group">
      		...
      		<select class="form-control"  name="month">
    				...
    				<input type="submit" class="btn btn-success" value="View monthly summary"></button>
    			</form>
