...
$msg = $this->session->flashdata('Telecasted_news');
...
?>
            ...
            <p class="panel-title"><h3> Telecasted News For the month</h3></p>
         	</div>
			<div class="panel-body">

			<form method='GET' action='<?php echo site_url("/reports/monthly_telecasted") ?>'>
