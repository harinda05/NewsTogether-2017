...
$msg = $this->session->flashdata('rej_news');
...
?>
            ...
            <p class="panel-title"><h3>Monthly Rejected News</h3></p>
         	</div>
			<div class="panel-body">

			<form method='GET' action='<?php echo site_url("/reports/rej_news_details") ?>'>
			 ...
			 <div class="form-group">
      		...
      		<select class="form-control"  name="month">
    				...
    				<input type="submit" class="btn btn-success" value="View rejected News"></button>
    			</form>
